...
<a href="index.html" class="navbar-brand p-0">
                ...
                <div class="navbar-nav ms-auto py-0">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <a href="./meeting.php" class="dropdown-item">Meeting Room</a>
                            ...
                            <a href="./virtual.php" class="dropdown-item active">Virtual Office</a>
                        </div>
                    </div>
 ...
 <div class="container-fluid bg-primary py-5 bg-header6 " style="margin-bottom: 90px;">
            <div class="row py-5">
                <div class="col-12 pt-lg-5 mt-lg-5 text-center">
                    <h1 class="display-4 text-white animated zoomIn">Flexible Virtual Office</h1>
    ...
    <div class="container-fluid py-5 wow fadeInUp" data-wow-delay="0.1s">
        <div class="container py-5">
            <div class="section-title text-center position-relative pb-3 mb-5 mx-auto" style="max-width: 600px;">
                ...
                <h1 class="mb-0">Virtual Office</h1>
            </div>
            <div class="row g-0">
    <?php 
    ...
    if (mysqli_num_rows($result) > 0) {
        ...
        while ($rows = mysqli_fetch_assoc($result)) {
            ?>
            <div class="col-lg-4 my-3 wow slideInUp" data-wow-delay="0.3s">
                <div class="bg-white rounded shadow position-relative" style="z-index: 1;">
                    ...
                    <div class="p-5 pt-0">
                        ...
                        <div class="d-flex justify-content-between mb-2">
                            <img src="<?php echo 'image_virtual/' . htmlspecialchars($rows['image']); ?>" alt="<?php echo htmlspecialchars($rows['title']); ?>" style="height: 300px; width: 300px;">
                        </div>
                        <a href="booking2.php?id=<?php echo $rows['id']; ?>" class="btn btn-primary py-2 px-4 mt-4 w-100">Book Now</a>
                    </div>
                </div>
            </div>
            <?php
