    ...
    <div class="container-fluid py-5 wow fadeInUp" data-wow-delay="0.1s">
        <div class="container py-5">
            <div class="section-title text-center position-relative pb-3 mb-5 mx-auto" style="max-width: 600px;">
                ...
                <h1 class="mb-0">Meeting Rooms</h1>
            </div>
            <div class="row g-0">
    <?php 
                ...
                <div class="bg-white rounded shadow position-relative" style="z-index: 1;">
                    ...
                    <div class="p-5 pt-0">
                        ...
                        <div class="d-flex justify-content-between mb-2">
                            <img src="<?php echo 'image_meeting/' . htmlspecialchars($rows['image']); ?>" alt="<?php echo htmlspecialchars($rows['title']); ?>" style="height: 300px; width: 300px;">
                        </div>
                        <a href="booking.php?id=<?php echo $rows['id']; ?>" class="btn btn-primary py-2 px-4 mt-4 w-100">Book Now</a>
                    </div>
                </div>
            </div>
            <?php
