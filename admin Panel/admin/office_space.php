...
<main class="app-content">
    <div class="app-title">
        <h1 class="display-3 text-primary">
            <i class="fa-solid fa-building-user"></i> Office Space
        </h1>
    </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h3 class="modal-title text-primary fw-bold" id="exampleModalLabel">Add Office Space</h3>
                ...
                <div class="modal-body">
                    ...
                    if (isset($_POST['submit'])) {
                        ...
                        $sql = "INSERT INTO office_space (title, about, image, price) VALUES ('$title', '$about', '$image', '$price')";

                        if (mysqli_query($conn, $sql)) {
                            echo "<script>
                                swal('Good job!', 'Office Space Added successfully!', 'success');
                                setTimeout(function(){
                            ...
                            echo "<script>
                                swal('Error!', 'There was an issue adding the Office Space.', 'error');
                                </script>";
                        }
                    }
                    ?>
                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td><img src="image_office/<?php echo $rows['image']; ?>" height="100px" width="100px"></td>
                                    <td><?php echo $rows['price']; ?></td>
                                    <td>
                                        <a href="office_space_delete.php?id=<?php echo $rows['id']; ?>" class="mx-5 text-primary">
                                            <i class="fa-solid fa-trash"></i>
                                        </a>
                                    </td>
                                    <td>
                                        <a href="office_space_edit.php?id=<?php echo $rows['id']; ?>" class="mx-5 text-primary">
